      ...
      <form onSubmit={onSubmit} className={styles.form} >
          ...
          <div>
            ...
            <div>
              <label>Telefone celular* <br />
                ...
                placeholder="(00) 12345-6789" required {...register("tCelular")} 
                onChange={e => setTel(e.target.value)} value={tel} autoComplete="off" /><br />
              </label>
              <label>Telefone fixo<br />
                <input className={styles.inputCurto} name="tfixo" 
                placeholder="(00) 1234-5678" {...register("tFixo")} 
                onChange={e => setTelFixo(e.target.value)} value={telFixo} 
                autoComplete="off" /><br />
              </label>
            </div>

            <label>CPF*</label><br />
            <input className={styles.inputCurto} id="cpf" name="cpf" 
            placeholder="111.222.333-44" required {...register("cpf")} 
            onChange={e => setCpf(e.target.value)} value={cpf} autoComplete="off" /><br />
        ...
        <div className={styles.enderecoCliente}>
          <div>
            ...
            {...register("endereco.0.nome")} required /> <br />

            <div>
              <label> Logradouro*<br />
                <input className={styles.inputCurto} 
                name="logradouro" placeholder="Av. Principal" 
                {...register("endereco.0.logradouro")} required /> <br />
              </label>
              <label> Num* <br />
